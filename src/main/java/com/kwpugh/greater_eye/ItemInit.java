...
public class ItemInit
{
	...
	public static final RegistryObject<Item> GREATER_EYE_END = ITEMS.register("greater_eye_end", () -> new ItemGreaterEyeEnd(new Item.Properties().maxStackSize(16).group(GreaterEye.greater_eye)));
	public static final RegistryObject<Item> GREATER_EYE_NETHER = ITEMS.register("greater_eye_nether", () -> new ItemGreaterEyeNether(new Item.Properties().maxStackSize(16).group(GreaterEye.greater_eye)));
}
