...
public class TagInit
{
    ...
    public static final TagKey<ConfiguredStructureFeature<?, ?>> MINESSHAFTS = TagKey.create(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY, new ResourceLocation("greater_eye",  "mineshafts"));
    public static final TagKey<ConfiguredStructureFeature<?, ?>> SHIPWRECKS = TagKey.create(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY, new ResourceLocation("greater_eye",  "shipwrecks"));
    ...
    public static final TagKey<ConfiguredStructureFeature<?, ?>> HUTS = TagKey.create(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY, new ResourceLocation("greater_eye",  "witch_huts"));
    ...
    public static final TagKey<ConfiguredStructureFeature<?, ?>> NETHER_FOSSILS = TagKey.create(Registry.CONFIGURED_STRUCTURE_FEATURE_REGISTRY, new ResourceLocation("greater_eye",  "nether_fossils"));
